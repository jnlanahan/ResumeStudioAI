...
var APIError = class _APIError extends AnthropicError {
  constructor(status, error, message, headers, type) {
    ...
    this.workspaceID = headers == null ? void 0 : headers.get("anthropic-workspace-id");
    this.error = error;
    this.type = type ?? null;
  }
  ...
  static generate(status, errorResponse, message, headers) {
    ...
    const type = (_a = error == null ? void 0 : error["error"]) == null ? void 0 : _a["type"];
    if (status === 400) {
...
//# sourceMappingURL=chunk-UOD5AXXY.js.map
